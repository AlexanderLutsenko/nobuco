...
#     take_dims, take_slice_specs = collect_take_indices_and_specs(slices_enumerated)
#
...
#
#         def fix_slices_enumerated(slices_enumerated, take_dims):
#             take_dims = take_dims[1:]
#             fixed = []
#             for i, s in slices_enumerated:
#                 shift = len([d for d in take_dims if i > d])
#                 fixed.append((i - shift, s))
#             return fixed
#         slices_enumerated = fix_slices_enumerated(slices_enumerated, take_dims)
#
